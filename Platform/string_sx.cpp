...
\+---------------------------------------------------------------------*/
errno_t
memcpy_sx( void* t, size_t tc, const void* s, size_t sc )
{
    errno_t eResult = 0;
    if ( tc < sc )
    {
...
\+---------------------------------------------------------------------*/
errno_t
strcpy_sx( char* t, size_t tc, const char* s )
{
    errno_t eResult = 0;
    char*   tEnd = t + tc;
...
\+---------------------------------------------------------------------*/
errno_t
strncpy_sx( char* t, size_t tc, const char* s, size_t sc )
{
    errno_t eResult = 0;
...
\+---------------------------------------------------------------------*/
errno_t
strcat_sx( char* t, size_t tc, const char* s )
{
    errno_t eResult = 0;
    size_t  tn = strlen( t );
...
\+---------------------------------------------------------------------*/
errno_t
strncat_sx( char* t, size_t tc, const char* s, size_t sc )
{
    errno_t eResult = 0;
    size_t  tn = strlen( t );
    if ( tc <= tn )
