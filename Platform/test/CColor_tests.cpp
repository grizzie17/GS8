...
Spec( it_supports_getting_its_components )
{
    ...
    AssertThat( c.GetRed(), ( 200U ) );
    AssertThat( c.GetGreen(), ( 100U ) );
    AssertThat( c.GetBlue(), ( 50U ) );
}
...
Spec( it_supports_copy )
{
    ...
    AssertThat( c2.GetRed(), ( 200u ) );
    AssertThat( c2.GetGreen(), ( 100u ) );
    AssertThat( c2.GetBlue(), ( 50u ) );
}
...
Spec( it_can_return_its_value )
{
    ...
    AssertThat( d, ( 0x0033CCFFu ) );
}

COLORDATA
colorArg( COLORDATA c )
{
    return c;
}
