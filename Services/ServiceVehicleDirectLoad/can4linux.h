 ...
 *------------------------------------------------------------------
 * $Header: /z2/cvsroot/products/0530/software/can4linux/src/can4linux.h,v 1.15 2008/02/25 11:10:12 oe Exp $
 *
 *--------------------------------------------------------------------------
 *
 *
...
#define CANDRIVERERROR  0xFFFFFFFF
...
/**
IOCTL Config request parameter structure */
struct Config_par {
    int cmd;			/**< special driver command */
    int target;			/**< special configuration target */
    unsigned long val1;		/**< 1. parameter for the target */
    unsigned long val2;		/**< 2. parameter for the target */
    unsigned long val3;		/**< 3. parameter for the target */
    int error;	 		/**< return value */
    unsigned long retval;	/**< return value */
};
...
typedef struct Config_par  Config_par_t ; /**< Configuration parameter struct */
