...
//	public functions  ---------------------------------------------------
	...
	CMatrix3x3dRef	operator=( ConstCMatrix3x3dRef r );		// assignment

	void			Set( ConstCMatrix3x3dRef r );
	void			Set( double m11, double m12, double m13,
								double m21, double m22, double m23,
								double m31, double m32, double m33 );
	void			Get( double* m11, double* m12, double* m13,
								double* m21, double* m22, double* m23,
								double* m31, double* m32, double* m33 ) const;

	bool			Equals( ConstCMatrix3x3dRef r ) const;
	bool			operator == ( ConstCMatrix3x3dRef r ) const;
	void			Invert( void );
	CMatrix3x3dRef	Multiply( ConstCMatrix3x3dRef r );
	CMatrix3x3d		ScalarMultiply( double fScale );
	CMatrix3x3d		Add( ConstCMatrix3x3dRef r );
	CMatrix3x3d		Transpose( void );
	void			Rotate( double fAngle );
	void			RotateAt( double fAngle, double xCenter, double yCenter );
	void			Scale( double xScale, double yScale );
	void			ScaleAt( double xScale, double yScale, double xCenter, double yCenter );
	void			Translate( double xOffset, double yOffset );

	void			Transform( double& xOut, double& yOut, double xIn, double yIn );

	CMatrix3x3dRef	operator*=( ConstCMatrix3x3dRef r );

	static CMatrix3x3d	_Identity( void );
	static CMatrix3x3d	_Scale( double fScale );
	static CMatrix3x3d	_Scale( double xScale, double yScale );
	static CMatrix3x3d	_ReflectX( void );		// reflect about X axis
	static CMatrix3x3d	_ReflectY( void );		// reflect about Y axis
	static CMatrix3x3d	_Translate( double x, double y );
	static CMatrix3x3d	_Rotate( double fRadians );
...
||																		|
\+=====================================================================*/
CMatrix3x3d	operator*( ConstCMatrix3x3dRef A, ConstCMatrix3x3dRef B );
